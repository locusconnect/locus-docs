...
const config: DocsThemeConfig = {
  ...
  logo: (
    <>
      ...
      <strong style={{ marginLeft: ".4em", fontWeight: 900 }}>
  ...
  project: {
    link: 'https://github.com/locusconnect/locus-docs',
  },
  
  docsRepositoryBase: 'https://github.com/locusconnect/locus-docs/tree/main',
  ...
  head: () => {
    return (
      <>
        ...
        <Script 
          src="https://www.googletagmanager.com/gtag/js?id=G-0WLKXL1TSZ" 
  ...
  banner: {
    ...
    text: (
      <span>
        🚧 Locus RTLS Documentation is currently in beta.{" "}
  ...
  footer: {
    text: (
      <span>
        Locus RTLS Documentation {new Date().getFullYear()} ©{" "}

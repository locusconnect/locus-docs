...
# Anchor Apollo (Wired) Installation Rules
...
<Callout type="warning" emoji="⚠️">
  To ensure accurate positioning, at least **four** anchors are required for position calculation. <br /><br />
...
<Callout type="info" emoji="✅">
  For optimal results, it's recommended to mount the anchors at the **same height** within each location cell. <br />

Here's a comprehensive API documentation in Markdown format:

# Locus WISE Analytics API Documentation

## Overview
The Locus WISE Analytics API provides endpoints for tracking and analyzing player performance data from wearable sensors. It supports real-time data collection, session management, and performance analytics.
...
### v1.0.0
- Initial API release
- Basic player and session management
- Real-time analytics processing
- WebSocket support for live updates

### v1.1.0
- Added support for multiple simultaneous sessions
- Improved analytics processing performance

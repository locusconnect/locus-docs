...
# Locus RTLS Overview
  ...
  fine tuning and custom optimisations. Date update rate, radio range, battery
...
- **Locus RF Planner** - A stand alone site survey tool for system installation personnel and system integrators. This tool help analyse, floorplans, no. of anchors needed and radio coverage to the installation teams
 ...
 **Locus 3D Map Generator** is currently in BETA Development Stage. Available to partners upon request.
</Callout>